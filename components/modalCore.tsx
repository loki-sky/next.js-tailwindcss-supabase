...
const ModalCore = ({ modalType }: Props) => {
  ...
  let title = "";
  let headerButton = "";
  let formElement = <p>The form could not be loaded.</p>;
  switch (modalType) {
  ...
  return (
    <>
      ...
      {showModal ? (
        <>
          <div className="overflow-y-auto overflow-x-hidden fixed top-0 pt-28 left-0 z-50 justify-center items-center w-full md:inset-0 max-h-full bg-black-rgba !ml-0">
